...
!-- START HOME -->
			...
			<div class="row">
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{asset('/storage/landing/asset/img/property/1.jpg')}}" class="img-fluid" alt="" />
				...
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{asset('/storage/landing/asset/img/property/2.jpg')}}" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
				...
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{asset('/storage/landing/asset/img/property/3.jpg')}}" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
	...
	<section class="template_property section-padding">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{asset('/storage/landing/asset/img/property/4.jpg')}}" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
				...
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{asset('/storage/landing/asset/img/property/5.jpg')}}" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
				...
				<div class="col-lg-4 col-sm-12 col-xs-12">
					<div class="single_property">
						<img src="{{asset('/storage/landing/asset/img/property/6.jpg')}}" class="img-fluid" alt="" />
						<div class="single_property_description text-center">
							<span><i class="fa fa-object-group"></i> 900 sq ft</span>
							<span><i class="fa fa-bed"></i> 4 Badrooms</span>
							<span><i class="fa fa-star-o"></i> 2 Baths</span>
		...
		<div class="container">
			...
			<div class="row portfolio-items-list">
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen garage">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/1.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/1.jpg')}}"></a>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom garage">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/2.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/2.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/3.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/3.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix garage kitchen">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/4.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/4.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/5.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/5.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/6.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/6.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix basement garage">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/7.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/7.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom basement">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/8.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/8.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
				...
				<div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom basement">
					<div class="grid">
						<figure class="effect-apollo">
							<img src="{{asset('/storage/landing/asset/img/portfolio/9.jpg')}}" class="img-fluid" alt="" />
							<figcaption>
								<a class="prettyPhoto image_zoom" href="{{asset('/storage/landing/asset/img/portfolio/9.jpg')}}"></a>
								<p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a></p>
							</figcaption>
						</figure>
					</div>
	...
	<section id="team" class="our_team section-padding">
		<div class="container">
			...
			<div class="row text-center">
				...
				<div class="col-lg-3 col-sm-3 col-xs-12">
					<div class="single_team">
						<img src="{{asset('/storage/landing/asset/img/team/team-3.jpg')}}" class="img-fluid" alt="" />
						<h3>Syed Ekram</h3>
						<p>Co Founder</p>
						<ul class="list-inline">
							<li><a href="#" class="st-facebook"><i class="fa fa-facebook"></i></a></li>
				...
				<div class="col-lg-3 col-sm-3 col-xs-12">
					<div class="single_team">
						<img src="{{asset('/storage/landing/asset/img/team/team-4.jpg')}}" class="img-fluid" alt="" />
						<h3>Hanjala Haque</h3>
						<p>Co Founder</p>
						<ul class="list-inline">
							<li><a href="#" class="st-facebook"><i class="fa fa-facebook"></i></a></li>
	...
	<section data-stellar-background-ratio="0.3" class="our_testimonial section-padding"
		style="background-image: url({{asset('/storage/landing/asset/img/bg/testimonial-bg.jpg')}});  "background-size:cover;background-position:center;">
		<div class="container">
			<div class="row">
				<div class="col-lg-8 offset-lg-2 col-sm-12 col-xs-12 text-center">
					<div class="testimonial1-carousel">
						<div class="single-testimonial">
							<img src="{{asset('/storage/landing/asset/img/testimonial/1.jpg')}}" alt="">
							<h4>Mark Richard</h4>
						...
						<div class="single-testimonial">
							<img src="{{asset('/storage/landing/asset/img/testimonial/2.jpg')}}" alt="">
							<h4>Mark Richard</h4>
							<span>Architecture</span>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae risus nec dui
								venenatis dignissim. Aenean vitae metus in augue pretium ultrices. Duis dictum eget
						...
						<div class="single-testimonial">
							<img src="{{asset('/storage/landing/asset/img/testimonial/3.jpg')}}" alt="">
							<h4>Mark Richard</h4>
							<span>Architecture</span>
							<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce vitae risus nec dui
								venenatis dignissim. Aenean vitae metus in augue pretium ultrices. Duis dictum eget
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="partner  wow fadeInRight">
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/1.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/2.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/3.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/4.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/5.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/1.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/2.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/3.png')}}" alt="image"></a>
						<a href="#"><img src="{{asset('/storage/landing/asset/img/partner/4.png')}}" alt="image"></a>
			...
			<div class="row">
				<div class="col-lg-4 col-sm-4 col-xs-12">
					<div class="single_blog">
						<div class="blog_img">
							<a href="blog.html"><img src="{{asset('/storage/landing/asset/img/blog/blog-1.jpg')}}" class="img-fluid"
									alt="image" /></a>
							<div class="post-date">
				...
				<div class="col-lg-4 col-sm-4 col-xs-12">
					<div class="single_blog">
						<div class="blog_img">
							<a href="blog.html"><img src="{{asset('/storage/landing/asset/img/blog/blog-2.jpg')}}" class="img-fluid"
									alt="image" /></a>
							<div class="post-date">
				...
				<div class="col-lg-4 col-sm-4 col-xs-12">
					<div class="single_blog">
						<div class="blog_img">
							<a href="blog.html"><img src="{{asset('/storage/landing/asset/img/blog/blog-3.jpg')}}" class="img-fluid"
									alt="image" /></a>
							<div class="post-date">
