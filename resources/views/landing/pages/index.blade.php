...
@section('content')
    ...
    <section id="home" class="home_bg"
        style="background-image: url({{ asset('/storage/landing/asset/img/bg/home-bg.jpg') }}); background-size:cover;
                    ...
                    <div class="col-lg-4 col-sm-12 col-xs-12">
                        <div class="single_property">
                            ...
                            <div class="single_property_content">
                                <h4><a href="{{ route('landing.zones', $zone->id) }}">{{ $zone->name }}</a></h4>
                                <p>{{ $zone->description }}</p>
                            </div>
                            <div class="single_property_price">
                                Per PAX <span>Rp. {{ $zone->price }}</span>
            ...
            <div class="row">
				@forelse($attractions as $attraction)
                    ...
                    <div class="single_property">
                        ...
                        <div class="single_property_content">
                            <h4><a href="{{ route('landing.attractions', $attraction->id) }}">{{ $attraction->name }}</a></h4>
        ...
        <div class="container">
            ...
            <div class="row portfolio-items-list">
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen garage">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/1.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/1.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                    </div>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom garage">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/2.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/2.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/3.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/3.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix garage kitchen">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/4.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/4.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/5.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/5.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bathroom kitchen">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/6.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/6.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix basement garage">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/7.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/7.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom basement">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/8.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/8.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12 mix bedroom basement">
                    <div class="grid">
                        <figure class="effect-apollo">
                            <img src="{{ asset('/storage/landing/asset/img/portfolio/9.jpg') }}" class="img-fluid"
                                alt="" />
                            <figcaption>
                                <a class="prettyPhoto image_zoom"
                                    href="{{ asset('/storage/landing/asset/img/portfolio/9.jpg') }}"></a>
                                <p><a href="#" data-toggle="modal" data-target="#projectModal">Your Dream House</a>
                                </p>
                            </figcaption>
                        </figure>
            ...
            <div class="row text-center">
                <div class="col-lg-3 col-sm-3 col-xs-12">
                    <div class="single_team">
                        <img src="{{ asset('/storage/landing/asset/img/team/team-1.jpg') }}" class="img-fluid"
                            alt="" />
                        <h3>Juthi Ahmed</h3>
                        <p>Co Founder</p>
                ...
                <div class="col-lg-3 col-sm-3 col-xs-12">
                    <div class="single_team">
                        <img src="{{ asset('/storage/landing/asset/img/team/team-2.jpg') }}" class="img-fluid"
                            alt="" />
                        <h3>Masum Billah</h3>
                        <p>Co Founder</p>
                        <ul class="list-inline">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-12">
                    <div class="single_team">
                        <img src="{{ asset('/storage/landing/asset/img/team/team-3.jpg') }}" class="img-fluid"
                            alt="" />
                        <h3>Syed Ekram</h3>
                        <p>Co Founder</p>
                        <ul class="list-inline">
                ...
                <div class="col-lg-3 col-sm-3 col-xs-12">
                    <div class="single_team">
                        <img src="{{ asset('/storage/landing/asset/img/team/team-4.jpg') }}" class="img-fluid"
                            alt="" />
                        <h3>Hanjala Haque</h3>
                        <p>Co Founder</p>
                        <ul class="list-inline">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="partner  wow fadeInRight">
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/1.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/2.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/3.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/4.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/5.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/1.png') }}"
                                alt="image"></a>
                        <a href="#"><img src="{{ asset('/storage/landing/asset/img/partner/2.png') }}"
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3 col-sm-12 col-xs-12 text-center">
                    <div class="signup_form">
                        ...
                        <form novalidate="" class="validate" name="mc-embedded-subscribe-form" method="post"
                            action="#">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <div class="single_blog">
                        <div class="blog_img">
                            <a href="blog.html"><img src="{{ asset('/storage/landing/asset/img/blog/blog-1.jpg') }}"
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <div class="single_blog">
                        <div class="blog_img">
                            <a href="blog.html"><img src="{{ asset('/storage/landing/asset/img/blog/blog-2.jpg') }}"
                                    class="img-fluid" alt="image" /></a>
                            <div class="post-date">
                ...
                <div class="col-lg-4 col-sm-4 col-xs-12">
                    <div class="single_blog">
                        <div class="blog_img">
                            <a href="blog.html"><img src="{{ asset('/storage/landing/asset/img/blog/blog-3.jpg') }}"
                                    class="img-fluid" alt="image" /></a>
                            <div class="post-date">
