...
<!-- START SECTION TOP -->
			...
			<div class="row">
				<div class="col-md-9 col-sm-9 col-xs-12">
					<div class="property_single_details_slide">
						<img src="{{asset('storage/images/' . $zone->image)}}" class="img-fluid" alt="About-Slide">
					</div>
				...
				<div class="col-md-3 col-sm-3 col-xs-12">
					<div class="single_property_form">
						...
						<form class="form" name="enq" method="post" action="{{ route('landing.zone.reviews.store') }}" onsubmit="return validation();">
							@csrf
							<div class="row">
    ...
    @empty
        <div class="text-center text-muted p-4 border rounded">
            Belum ada review untuk zone ini.
        </div>
    @endforelse
</div>
				</div><!--- END COL -->
